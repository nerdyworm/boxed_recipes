...
export EC2_PRIVATE_KEY=${EC2_KEY_DIR}/pk-Q4SGBNISNF4KGIBXD5QHSJF2XO3EQAUI.pem
export EC2_CERT=${EC2_KEY_DIR}/cert-Q4SGBNISNF4KGIBXD5QHSJF2XO3EQAUI.pem
export EC2_HOME='/root/ec2-api-tools-1.4.0.2'
